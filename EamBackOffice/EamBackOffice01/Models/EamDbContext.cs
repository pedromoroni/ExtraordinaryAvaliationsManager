...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=ROTOM;database=eam;Trusted_Connection=True;trustservercertificate=True;MultipleActiveResultSets=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Class>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Class__3213E83F1B6A8030");
            ...
            entity.HasOne(d => d.Course).WithMany(p => p.Classes)
                ...
                .HasConstraintName("FK__Class__course_id__4CA06362");
        });

        modelBuilder.Entity<Course>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Course__3213E83F02D1B69D");
            ...
            entity.HasMany(d => d.Subjects).WithMany(p => p.Courses)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<Subject>().WithMany()
                        ...
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__CourseSub__subje__4E88ABD4"),
                    l => l.HasOne<Course>().WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__CourseSub__cours__4D94879B"),
                    j =>
                    {
                        j.HasKey("CourseId", "SubjectId").HasName("PK__CourseSu__9A1EB8C8D000BCC5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Module__3213E83F0646D886");
            ...
            entity.HasOne(d => d.Subject).WithMany(p => p.Modules)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Module__subject___4F7CD00D");
        });

        modelBuilder.Entity<Request>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Request__3213E83FB81CB4AF");
            ...
            entity.HasOne(d => d.Course).WithMany(p => p.Requests)
                .HasForeignKey(d => d.CourseId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Request__course___5070F446");

            entity.HasOne(d => d.Module).WithMany(p => p.Requests)
                .HasForeignKey(d => d.ModuleId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Request__module___5165187F");

            entity.HasOne(d => d.Situation).WithMany(p => p.Requests)
                .HasForeignKey(d => d.SituationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Request__situati__52593CB8");
            ...
            entity.HasOne(d => d.Student).WithMany(p => p.RequestStudents)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Request__student__5441852A");

            entity.HasOne(d => d.Teacher).WithMany(p => p.RequestTeachers)
                .HasForeignKey(d => d.TeacherId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Request__teacher__5535A963");
        });

        modelBuilder.Entity<RequestHistory>(entity =>
        {
            entity.HasKey(e => new { e.RequestId, e.StatusId }).HasName("PK__RequestH__1BBB825CC3AAD908");
            ...
            entity.HasOne(d => d.Request).WithMany(p => p.RequestHistories)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__RequestHi__reque__5629CD9C");

            entity.HasOne(d => d.Status).WithMany(p => p.RequestHistories)
                .HasForeignKey(d => d.StatusId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__RequestHi__statu__571DF1D5");

            entity.HasOne(d => d.User).WithMany(p => p.RequestHistories)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__RequestHi__user___5812160E");
        });

        modelBuilder.Entity<Role>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Role__3213E83F5C3B5544");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Situatio__3213E83FAC8E8CF1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Status__3213E83FF30F0329");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Subject__3213E83FF9197C7B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__User__3213E83F65514646");
            ...
            entity.HasOne(d => d.Class).WithMany(p => p.Users)
                ...
                .HasConstraintName("FK__User__class_id__5AEE82B9");

            entity.HasOne(d => d.Role).WithMany(p => p.Users)
                .HasForeignKey(d => d.RoleId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__User__role_id__5BE2A6F2");
            ...
            entity.HasMany(d => d.Subjects).WithMany(p => p.Teachers)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    l => l.HasOne<User>().WithMany()
                        ...
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__TeacherSu__teach__59FA5E80"),
                    j =>
                    {
                        j.HasKey("TeacherId", "SubjectId").HasName("PK__TeacherS__16AE38189494FA63");
